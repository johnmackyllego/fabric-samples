...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	invoices := []Invoice{
		// Invoice{InvoiceNumber: "INVOICE-1", BilledTo: "Machy", InvoiceDate: "now", InvoiceAmount: "100", ItemDescription: "Goods", GR: "true", IsPaid: "false", PaidAmount: "10", Repaid: "true", RepaymentAmount: "1"},
		// Invoice{InvoiceNumber: "INVOICE-2", BilledTo: "Ira", InvoiceDate: "now", InvoiceAmount: "200", ItemDescription: "Bads", GR: "false", IsPaid: "true", PaidAmount: "20", Repaid: "false", RepaymentAmount: "2"},
		// Invoice{InvoiceNumber: "INVOICE-3", BilledTo: "John", InvoiceDate: "now", InvoiceAmount: "300", ItemDescription: "Laptops", GR: "true", IsPaid: "false", PaidAmount: "30", Repaid: "true", RepaymentAmount: "3"},
		// Invoice{InvoiceNumber: "INVOICE-4", BilledTo: "Eliza", InvoiceDate: "now", InvoiceAmount: "400", ItemDescription: "Cars", GR: "false", IsPaid: "true", PaidAmount: "40", Repaid: "false", RepaymentAmount: "4"},
	}
